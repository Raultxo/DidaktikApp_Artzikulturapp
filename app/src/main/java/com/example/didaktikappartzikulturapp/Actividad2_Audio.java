...
public class Actividad2_Audio extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.actividad2_audio);
        ...
        btnContinuar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Actividad2_Audio.this, Actividad2.class);
        ...
        //audio
        mp = MediaPlayer.create(Actividad2_Audio.this, R.raw.audio2);
